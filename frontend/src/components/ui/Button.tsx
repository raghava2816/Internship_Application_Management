...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    destructive: 'bg-accent-danger text-white hover:bg-red-600 focus:ring-accent-danger',
    ghost: 'bg-transparent text-foreground hover:bg-muted focus:ring-primary',
    glass: 'glass text-foreground hover:bg-opacity-80 focus:ring-primary border border-white/10 dark:border-white/5'
  };
